    ...
    <div class="mb-8">
        <div class="flex items-center gap-4 mb-6">
            ...
            <div>
                ...
                <p class="text-gray-600 mt-1">Update warehouse information - {{ $warehouse->name }}</p>
            </div>
        </div>
    </div>

    <!-- Form -->
    <form id="editWarehouseForm" method="POST" action="{{ route('admin.warehouses.update', $warehouse->id) }}">
        @csrf
        @method('PUT')
                ...
                <div class="form-group">
                    ...
                    <select name="status" required class="form-input @error('status') border-red-500 @enderror">
                        @foreach($statuses as $status)
                            <option value="{{ $status }}" {{ old('status', $warehouse->status) == $status ? 'selected' : '' }}>
                                {{ ucfirst($status) }}
                            </option>
                        @endforeach
                    </select>
        ...
        <div class="form-section">
            ...
            <div class="form-group">
                ...
                <textarea name="address" required rows="3" placeholder="Enter complete warehouse address" 
                          class="form-input @error('address') border-red-500 @enderror">{{ old('address', $warehouse->address) }}</textarea>
                @error('address')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="state" value="{{ old('state', $warehouse->state) }}" required 
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="form-group">
                    ...
                    <input type="number" step="0.00000001" name="latitude" value="{{ old('latitude', $warehouse->latitude) }}" 
                ...
                <div class="form-group">
                    ...
                    <input type="number" step="0.00000001" name="longitude" value="{{ old('longitude', $warehouse->longitude) }}" 
        ...
        <div class="form-section">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="form-group">
                    ...
                    <input type="tel" name="manager_phone" value="{{ old('manager_phone', $warehouse->manager_phone) }}" 
        ...
        <div class="form-section">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div class="form-group">
                    ...
                    <input type="number" name="storage_capacity" value="{{ old('storage_capacity', $warehouse->storage_capacity) }}" required min="0" 
                ...
                <div class="form-group">
                    ...
                    <input type="number" step="0.01" name="area_sqm" value="{{ old('area_sqm', $warehouse->area_sqm) }}" min="0" 
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="loading_docks" value="{{ old('loading_docks', $warehouse->loading_docks) }}" min="0" 
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="staff_count" value="{{ old('staff_count', $warehouse->staff_count) }}" min="0" 
        ...
        <div class="form-section">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="form-group">
                    ...
                    <input type="time" name="opening_time" value="{{ old('opening_time', $warehouse->opening_time) }}" 
                ...
                <div class="form-group">
                    ...
                    <input type="time" name="closing_time" value="{{ old('closing_time', $warehouse->closing_time) }}" 
                    ...
                    @foreach($days as $day)
                        <label class="checkbox-card flex items-center">
                            <input type="checkbox" name="operating_days[]" value="{{ $day }}" 
                                   {{ (is_array(old('operating_days')) ? in_array($day, old('operating_days')) : (is_array($warehouse->operating_days) && in_array($day, $warehouse->operating_days))) ? 'checked' : '' }}
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <label class="checkbox-card flex items-center">
                    <input type="checkbox" name="is_pickup_point" value="1" 
                           {{ old('is_pickup_point', $warehouse->is_pickup_point) ? 'checked' : '' }}
                ...
                <label class="checkbox-card flex items-center">
                    <input type="checkbox" name="is_delivery_point" value="1" 
                           {{ old('is_delivery_point', $warehouse->is_delivery_point) ? 'checked' : '' }}
                           class="w-5 h-5 text-blue-600 border-gray-300 rounded focus:ring-2 focus:ring-blue-500"/>
                ...
                <label class="checkbox-card flex items-center">
                    <input type="checkbox" name="accepts_cod" value="1" 
                           {{ old('accepts_cod', $warehouse->accepts_cod) ? 'checked' : '' }}
                           class="w-5 h-5 text-blue-600 border-gray-300 rounded focus:ring-2 focus:ring-blue-500"/>
                ...
                <label class="checkbox-card flex items-center">
                    <input type="checkbox" name="has_cold_storage" value="1" 
                           {{ old('has_cold_storage', $warehouse->has_cold_storage) ? 'checked' : '' }}
                           class="w-5 h-5 text-blue-600 border-gray-300 rounded focus:ring-2 focus:ring-blue-500"/>
                ...
                <label class="checkbox-card flex items-center">
                    <input type="checkbox" name="has_24h_security" value="1" 
                           {{ old('has_24h_security', $warehouse->has_24h_security) ? 'checked' : '' }}
                           class="w-5 h-5 text-blue-600 border-gray-300 rounded focus:ring-2 focus:ring-blue-500"/>
        ...
        <div class="form-section">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="form-group">
                    ...
                    <input type="number" step="0.01" name="monthly_rent" value="{{ old('monthly_rent', $warehouse->monthly_rent) }}" min="0" 
                ...
                <div class="form-group">
                    ...
                    <input type="number" step="0.01" name="utility_cost" value="{{ old('utility_cost', $warehouse->utility_cost) }}" min="0" 
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="license_number" value="{{ old('license_number', $warehouse->license_number) }}" 
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="license_expiry" value="{{ old('license_expiry', $warehouse->license_expiry) }}" 
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="last_inspection_date" value="{{ old('last_inspection_date', $warehouse->last_inspection_date) }}" 
                ...
                <div class="form-group">
                    ...
                    <select name="safety_rating" class="form-input @error('safety_rating') border-red-500 @enderror">
                        ...
                        @foreach($safetyRatings as $rating)
                            <option value="{{ $rating }}" {{ old('safety_rating', $warehouse->safety_rating) == $rating ? 'selected' : '' }}>
            ...
            <div class="space-y-6">
                <div class="form-group">
                    ...
                    <textarea name="description" rows="3" placeholder="Brief description of the warehouse facility..." 
                              class="form-input @error('description') border-red-500 @enderror">{{ old('description', $warehouse->description) }}</textarea>
                    @error('description')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="special_instructions" rows="3" placeholder="Any special handling instructions or notes..." 
                              class="form-input @error('special_instructions') border-red-500 @enderror">{{ old('special_instructions', $warehouse->special_instructions) }}</textarea>
