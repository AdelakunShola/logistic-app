...
<div class="container mx-auto px-4 py-6">
    <!-- Back Button -->
    <div class="mb-6">
        <a href="{{ route('admin.notifications.all') }}" class="inline-flex items-center text-sm text-gray-600 hover:text-gray-900">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div class="mt-6 flex gap-3">
            <a href="{{ route('admin.maintenance.edit', $relatedData->id) }}" 
